...
typedef enum {
	/** No error. */
	DASSKeychainErrorNone = noErr,
	
	/** Some of the arguments were invalid. */
	DASSKeychainErrorBadArguments = -1001,
	
	/** There was no password. */
	DASSKeychainErrorNoPassword = -1002,
	
	/** One or more parameters passed internally were not valid. */
	DASSKeychainErrorInvalidParameter = errSecParam,
	
	/** Failed to allocate memory. */
	DASSKeychainErrorFailedToAllocated = errSecAllocate,
	
	/** No trust results are available. */
	DASSKeychainErrorNotAvailable = errSecNotAvailable,
	
	/** Authorization/Authentication failed. */
	DASSKeychainErrorAuthorizationFailed = errSecAuthFailed,
	
	/** The item already exists. */
	DASSKeychainErrorDuplicatedItem = errSecDuplicateItem,
	
	/** The item cannot be found.*/
	DASSKeychainErrorNotFound = errSecItemNotFound,
	
	/** Interaction with the Security Server is not allowed. */
	DASSKeychainErrorInteractionNotAllowed = errSecInteractionNotAllowed,
	
	/** Unable to decode the provided data. */
	DASSKeychainErrorFailedToDecode = errSecDecode
} DASSKeychainErrorCode;

extern NSString *const DAkSSKeychainErrorDomain;

/** Account name. */
extern NSString *const DAkSSKeychainAccountKey;
 ...
 */
extern NSString *const DAkSSKeychainCreatedAtKey;

/** Item class. */
extern NSString *const DAkSSKeychainClassKey;

/** Item description. */
extern NSString *const DAkSSKeychainDescriptionKey;

/** Item label. */
extern NSString *const DAkSSKeychainLabelKey;

/** Time the item was last modified.
 
 The value will be a string.
 */
extern NSString *const DAkSSKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const DAkSSKeychainWhereKey;
 ...
 */
@interface DASSKeychain : NSObject
